    ...
    <div class="s-area has-background-light">
      <div class="tabs is-centered">
        <ul>
          ...
          <li class="is-active"><router-link v-bind:to="'/search/tag/' + this.query_text"><i class="fas fa-tags"></i></router-link></li>
...
export default {
  ...
  methods: {
    ...
    created_method:async function(query_text) {
      try {
        let res = await axios.get('/api/search/tag?words=' + encodeURIComponent(query_text) + '&page=' + this.page);
